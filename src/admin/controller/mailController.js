...
<tr><td align="center">
<img src="${process.env.BASEURL}/assets/app-logo.png" alt="Tradizions Logo" style="height: 60px; max-width: 100%; object-fit: contain; margin-bottom: 20px; display: block;" />
            ...
            <table cellpadding="0" cellspacing="0">
              <tr>
                <td style="padding-right:12px;vertical-align:middle;">
                  <img src="${item.productImage && item.productImage.includes("http") ? item.productImage : "https://demo.sevanta.in/api" + (item.productImage || "")}"
